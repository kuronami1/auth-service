  ...
  return (
    <>
      <div className="min-h-screen flex justify-center items-center">
        <form className="bg-gray-100 flex flex-col gap-4 w-80 p-8 rounded-xl shadow-xl">
          ...
          <label className="flex flex-col gap-1">
            <span className="text-md text-gray-600 font-bold">Email</span>
          ...
          <label className="flex flex-col gap-1">
            <span className="text-md text-gray-600 font-bold">Password</span>
